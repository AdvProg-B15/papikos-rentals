...
//         UserDetailsDto tenantDetails = authServiceClient.getUserDetails(tenantUserId);
//         if (!"TENANT".equals(tenantDetails.getRole())) {
...
//         }
    ...
    public RentalDto getRentalById(UUID rentalId, UUID userId) {
        ...
        // UserDetailsDto userDetails = authServiceClient.getUserDetails(userId);
        // if (!Objects.equals(rental.getTenantUserId(), userId) &&
        //     !Objects.equals(rental.getOwnerUserId(), userId) &&
    ...
    private void triggerVacancyCheck(UUID kosId) {
        ...
        // notificationServiceClient.triggerVacancyNotification(kosId); // Assuming this takes UUID
    }
